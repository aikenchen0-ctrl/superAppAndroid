...
class ChannelsLiveFullScreenContractTest {
    ...
    fun channelsLiveUsesItsOwnActionModeAndDocumentedMaterialDraftApi() {
        val actionSource = File(
            ...
            "src/main/kotlin/com/paifa/ubikitouch/accessibility/floatingchat/tools/ToolActionDispatch.kt"
        ).readText()
        val apiSource = File(
            System.getProperty("user.dir"),
            "src/main/kotlin/com/paifa/ubikitouch/accessibility/scrm/ScrmApiClient.kt"
        ).readText()
