...
class VideoAspectRatioTest {
    ...
    @Test
    fun aspectFillCropsTheLongerAxisInsteadOfLeavingBars() {
        assertEquals(
            16f / 9f,
            textureViewScaleForAspectFill(1_000, 1_000, 16f / 9f).first,
            0.0001f
        )
        assertEquals(
            16f / 9f,
            textureViewScaleForAspectFill(1_000, 1_000, 9f / 16f).second,
            0.0001f
        )
    }
}
