...
import com.paifa.ubikitouch.accessibility.floatingchat.shell.voiceCallEnterOffsetDirection
import com.paifa.ubikitouch.accessibility.floatingchat.shell.voiceCallExitOffsetDirection
import com.paifa.ubikitouch.accessibility.floatingchat.shell.voiceCallUsesFullscreenWorkspace
    ...
    fun voiceCallOpensFullscreenWorkspace() {
        assertEquals(
            ToolActionDispatch.OpenBottomPanel(
                com.paifa.ubikitouch.accessibility.floatingchat.shell.BottomPanelMode.VoiceCall
            ),
