...
internal fun shouldSynchronizeEdgeIndicators(
    mode: ResolvedGestureInputMode,
    edgeGestureWindowsAllowed: Boolean,
    nativeGestureStarted: Boolean
): Boolean {
    return mode == ResolvedGestureInputMode.NativeTouchInteraction &&
        edgeGestureWindowsAllowed &&
