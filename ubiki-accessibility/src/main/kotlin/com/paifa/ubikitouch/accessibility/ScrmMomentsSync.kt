...
import com.paifa.ubikitouch.accessibility.scrm.ScrmMomentVisibilityPayload
...
import com.paifa.ubikitouch.accessibility.scrm.ScrmMomentCommentDeleteRequest
import com.paifa.ubikitouch.accessibility.scrm.ScrmMomentDetailRequest
...
internal fun publishScrmMoment(
    ...
    val visibleFriends = when (options.visibility) {
        com.paifa.ubikitouch.accessibility.scrm.ScrmMomentVisibility.PartVisible,
        com.paifa.ubikitouch.accessibility.scrm.ScrmMomentVisibility.NotVisible ->
    ...
    return submitScrmMomentTaskAndAwait(session.taskApi, treatMissingRecentTaskAsAccepted = true) {
        session.momentApi.postMoment(
            ScrmPostMomentRequest(
                ...
                friendWxids = if (options.visibility == com.paifa.ubikitouch.accessibility.scrm.ScrmMomentVisibility.PartVisible) {
                    visibleFriends
                } else {
                    null
                },
                invisibleFriendWxids = if (options.visibility == com.paifa.ubikitouch.accessibility.scrm.ScrmMomentVisibility.NotVisible) {
                    visibleFriends
                } else {
                    null
                },
