...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    // NOTE: This class path MUST match the Kotlin PairingContext class location.
    env->RegisterNatives(env->FindClass("com/adbcore/adb/PairingContext"), methods_PairingContext,
