...
private fun EdgeFunctionSettingsScreen(
    ...
    var edgePicker by remember { mutableStateOf<Pair<EdgeSide, GestureType>?>(null) }
...
private fun ConfigurationTarget.edgeSideOrNull(): EdgeSide? = when (this) {
    ConfigurationTarget.LEFT -> EdgeSide.LEFT
    ConfigurationTarget.RIGHT -> EdgeSide.RIGHT
