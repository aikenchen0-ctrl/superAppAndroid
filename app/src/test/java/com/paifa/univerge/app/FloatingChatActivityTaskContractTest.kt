...
class FloatingChatActivityTaskContractTest {
    ...
    fun gestureServiceDeclaresPersistenceHooks() {
        ...
        val service = manifest.service("com.paifa.univerge.accessibility.UbikiAccessibilityService")
        ...
        assertTrue(receiver.actions.contains("com.paifa.univerge.action.RECOVER_GESTURE"))

        val keepAlive = manifest.service("com.paifa.univerge.accessibility.UbikiGestureKeepAliveService")
