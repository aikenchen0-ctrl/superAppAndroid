...
import com.paifa.univerge.accessibility.floatingchat.popup.BalloonCoordinateState
import com.paifa.univerge.accessibility.floatingchat.popup.BalloonPopupState
import com.paifa.univerge.accessibility.floatingchat.popup.IrregularBalloonPopup
...
internal fun messageSupportsVoiceTranscription(message: FloatingChatMessage): Boolean {
    return message.type == com.paifa.univerge.core.model.FloatingChatMessageType.Voice &&
...
internal fun messageRemoteIdForVoiceTranscription(
    ...
    return candidates.asSequence()
        .filter {
            it.type == com.paifa.univerge.core.model.FloatingChatMessageType.Voice &&
...
internal fun messageLongPressActionsFor(message: FloatingChatMessage): List<MessageLongPressAction> {
    return buildList {
        if (message.type == com.paifa.univerge.core.model.FloatingChatMessageType.Voice) {
