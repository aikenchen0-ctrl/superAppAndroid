...
import com.paifa.univerge.accessibility.floatingchat.shell.FloatingChatMediaOverlayState
...
internal class FavoriteCollectionActions(
    ...
    fun removeFavoriteItem(item: FavoriteCollectionItem) {
        ...
        val nextItems = favoriteCollectionItemsAfterRemove(storedFavoriteItems, item)
