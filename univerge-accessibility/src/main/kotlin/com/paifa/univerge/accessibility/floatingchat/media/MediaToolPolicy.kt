...
import com.paifa.univerge.accessibility.scrm.scrmMediaOperationType
...
internal fun galleryVideoMessageForPlayback(): FloatingChatMessage {
    return FloatingChatMessage(
        ...
        senderName = "me",
        time = "刚刚",
        thumbnailUrl = "file:///data/user/0/com.paifa.univerge/cache/floating-chat-media/video-1.jpg",
        resourceUrl = "file:///data/user/0/com.paifa.univerge/cache/floating-chat-original-media/video-1.mp4"
    )
}
