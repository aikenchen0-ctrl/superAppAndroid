...
class FileFormatIconTest {
    ...
    private fun sourceFile(relativePath: String): java.io.File {
        val moduleRelative = java.io.File("src/main/kotlin/com/paifa/univerge/accessibility", relativePath)
        if (moduleRelative.exists()) return moduleRelative
        return java.io.File("univerge-accessibility/src/main/kotlin/com/paifa/univerge/accessibility", relativePath)
    }
}
