...
class AiVoiceAudioEngineContractTest {
    ...
    private fun sourceFile(): File {
        val moduleRelative = File(
            "src/main/kotlin/com/paifa/univerge/accessibility/floatingchat/aivoice/AiVoiceAudioEngine.kt"
        )
        if (moduleRelative.exists()) return moduleRelative
        return File(
            "univerge-accessibility/src/main/kotlin/com/paifa/univerge/accessibility/floatingchat/aivoice/AiVoiceAudioEngine.kt"
        )
    }
}
