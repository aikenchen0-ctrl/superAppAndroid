...
import com.paifa.univerge.accessibility.floatingchat.shell.miniProgramEnterOffsetDirection
import com.paifa.univerge.accessibility.floatingchat.shell.miniProgramExitOffsetDirection
import com.paifa.univerge.accessibility.floatingchat.shell.miniProgramUsesFullscreenWorkspace
...
class MiniProgramFullScreenContractTest {
    ...
    fun miniProgramActionOpensTheFullscreenWorkspace() {
        ...
        val catalogSource = File(
            ...
            "src/main/kotlin/com/paifa/univerge/accessibility/floatingchat/tools/RightRailToolCatalog.kt"
        ).readText()
