...
class AiVoicePanelContractTest {
    ...
    private fun sourceFile(name: String): File {
        val moduleRelative = File(
            "src/main/kotlin/com/paifa/univerge/accessibility/floatingchat/aivoice",
            name
        )
        if (moduleRelative.exists()) return moduleRelative
        return File(
            "univerge-accessibility/src/main/kotlin/com/paifa/univerge/accessibility/floatingchat/aivoice",
            name
        )
    }
}
