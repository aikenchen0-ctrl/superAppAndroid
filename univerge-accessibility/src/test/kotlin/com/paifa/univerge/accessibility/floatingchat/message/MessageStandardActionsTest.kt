...
import com.paifa.univerge.accessibility.floatingchat.aivoice.MessageAsideRequestTracker
...
class MessageStandardActionsTest {
    ...
    fun zoomRoutesTextMediaAndUnsupportedMessageTypes() {
        assertEquals(MessageZoomMode.Text, messageZoomMode(com.paifa.univerge.core.model.FloatingChatMessageType.Text))
        assertEquals(MessageZoomMode.Text, messageZoomMode(com.paifa.univerge.core.model.FloatingChatMessageType.MixedText))
        assertEquals(MessageZoomMode.Media, messageZoomMode(com.paifa.univerge.core.model.FloatingChatMessageType.ImageThumbnail))
        assertEquals(MessageZoomMode.Media, messageZoomMode(com.paifa.univerge.core.model.FloatingChatMessageType.CapturedPhoto))
        assertEquals(MessageZoomMode.Unsupported, messageZoomMode(com.paifa.univerge.core.model.FloatingChatMessageType.Voice))
    }
