...
import com.paifa.univerge.accessibility.floatingchat.shell.videoCallEnterOffsetDirection
import com.paifa.univerge.accessibility.floatingchat.shell.videoCallExitOffsetDirection
import com.paifa.univerge.accessibility.floatingchat.shell.videoCallUsesFullscreenWorkspace
    ...
    fun videoCallOpensFullscreenWorkspace() {
        assertEquals(
            ToolActionDispatch.OpenBottomPanel(
                com.paifa.univerge.accessibility.floatingchat.shell.BottomPanelMode.VideoCall
            ),
