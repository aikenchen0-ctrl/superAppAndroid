...
class RightRailWorkflowLabelTest {
    ...
    fun deviceToolOpensTheAccountDevicePanel() {
        assertEquals(
            ToolActionDispatch.OpenBottomPanel(
                com.paifa.univerge.accessibility.floatingchat.shell.BottomPanelMode.AccountDevice
            ),
    ...
    fun standardRailContainsFinderEntry() {
        ...
        assertEquals(
            ToolActionDispatch.OpenBottomPanel(
                com.paifa.univerge.accessibility.floatingchat.shell.BottomPanelMode.Finder
            ),
