...
class MomentsRuntimeBoundaryTest {
    ...
    fun momentsContractsDoNotDependOnPlatformOrScrmTypes() {
        ...
        val contractDir = File(
            root,
            "src/main/kotlin/com/paifa/univerge/accessibility/floatingchat/contract"
        )
        contractDir.walkTopDown()
            ...
            .forEach { source ->
                ...
                assertFalse("SCRM import leaked into ${source.name}", text.contains("import com.paifa.univerge.accessibility.scrm."))
            }
    }
